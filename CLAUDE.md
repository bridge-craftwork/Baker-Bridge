...
gathers it (BC spec R-CP3a). Done: Holdup, Finesse, Entries; pilot board Squeeze 2. The build prints a note for any question whose every legal card is accepted (a forced click).
